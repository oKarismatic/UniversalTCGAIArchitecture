...
*Original filename: "prompt for AI chat bot v1.txt"*

The content below is the original prompt converted to Markdown for readability.
...
7. Resolve using UROE: S → N → I → M → V/B/H/C → STATE UPDATE → repeat S cycle if triggers
